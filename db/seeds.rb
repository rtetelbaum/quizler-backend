...
quiz1 = Quiz.create(quizmaker: 'Roman Tetelbaum', title: 'JavaScript', subject: 'Coding Review', user: user1)
quiz2 = Quiz.create(quizmaker: 'Roman Tetelbaum', title: 'Top 10 Kubernetes Interview Questions', subject: 'Interview Prep', user: user1)
quiz3 = Quiz.create(quizmaker: 'Roman Tetelbaum', title: 'Top Common Interview PHP Questions', subject: 'Interview Prep', user: user1)
quiz4 = Quiz.create(quizmaker: 'Roman Tetelbaum', title: 'Basic Dockerfile Quiz', subject: 'DevOps Review', user: user1)
quiz5 = Quiz.create(quizmaker: 'Roman Tetelbaum', title: 'Common HTML Interview Questions', subject: 'Interview Prep', user: user1)
quiz6 = Quiz.create(quizmaker: 'Roman Tetelbaum', title: 'Linux Review', subject: 'Operating Systems', user: user1)
quiz7 = Quiz.create(quizmaker: 'Roman Tetelbaum', title: 'MySQL Review', subject: 'Database SYstems', user: user1)
quiz8 = Quiz.create(quizmaker: 'Roman Tetelbaum', title: 'BASH Commands', subject: 'Coding', user: user1)
quiz9 = Quiz.create(quizmaker: 'Roman Tetelbaum', title: 'Laravel Review', subject: 'Coding', user: user1)
quiz10 = Quiz.create(quizmaker: 'Roman Tetelbaum', title: 'WordPress Review', subject: 'Content Management Systems', user: user1)
